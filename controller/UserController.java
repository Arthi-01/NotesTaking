package com.example.takenote.service.impl;
...
import com.example.takenote.entity.Notes;
import com.example.takenote.entity.User;
import com.example.takenote.repository.NotesRepository;
import com.example.takenote.service.NotesService;
...
public class NotesServiceImpl implements NotesService {
	...
	public Notes updateNotes(Notes notes) {
		System.out.println("Ha ha ha :"+((Notes) notes).getId());;
		return this.notesRepository.save(notes);
	}
